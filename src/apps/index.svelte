    ...
    <article id="types">
        ...
        <section>
            ...
            <ul>
                ...
                <p>Регламентные работы по техническому обслуживанию легковых автомобилей всех моделей и марок. 
                    Не думайте о замене свечей, дайте нам разобраться с этим. В список входит: </p>
                <ul>
                    <li>Замена свечей</li>
